            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <div class="image-frame"
                        style="background-image: url('{{ asset('images/placeholder.jpg') }}'); background-position-y: 50%; margin-left:0;">
                    </div>
...
<div class="wrapper text-secondary" style="background: rgba(95, 149, 255, 0.8);">
                ...
                <div class="grid gap-8 md:grid-cols-8 sm:grid-cols-1">
                    ...
                    <div class="col-span-3 py-4 card md:col-start-2">
                        <div class="card-body">
                            ...
                            <p class="card-text">Our mission is to create wealth among the
                                technologically savvy youth in Africa while
                                also contributing to the overall growth and development of the continent.
                            </p>
                    ...
                    <div class="col-span-3 py-4 card">
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                Our vision is to introduce more people, especially those of African descent
                                on the
