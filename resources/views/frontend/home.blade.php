                ...
                <div class="col-sm-12 col-md-6">
                    ...
                    <div class="wrapper" style="margin-top:42px;">
                        ...
                        <form>
                            ...
                            <input type="text" class="form-control subs-mail" name="" placeholder="Enter Email">

                            <input type="submit" class="btn btn-primary bnt-frm" value="SUBSCRIBE" name="">
        ...
        <div class="wrapper padding-edges">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 center-text">
                    ...
                    <p style="margin:0px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p><br>
...
<div class="wrapper video-frame">
    ...
    <div class="container padding-edges">
