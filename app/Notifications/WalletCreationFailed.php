...
class WalletCreationFailed extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->line('We encountered problems automatically setting up your wallet. Kindly create a new wallet and link your wallet to your account manually.')
                    ->action('Link Existing Wallet', url('/'))
